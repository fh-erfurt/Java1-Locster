...
{
    public Chat            chat; // sollte hier auch ein eindeutiger Chat gespeichert werden? evtl. benötigt für deleteMessageFromChat()
    private User            sender;
    ...
    /**
     * Sends a message to a chat by calling the receiving function in the chat.
